...
import data from "./story/[slug]/data";
      ...
      >
        ...
        >
          ...
          >
            ...
            <Text size="md" fontSize={"1.2em"} fontWeight={"semibold"}>
              Popular Tags
            </Text>
            <hr />
            <VStack
          ...
          >
            ...
            <GridItem as="aside" margin="0!important">
              <VStack rowGap="2em" minHeight="800px">
                {/* {//free area for ad maybe} */}
                <Box p="1em" borderRadius="1em" w="100%" h="auto">
                  <Image src="/uploads/advert.jpg" w="100%"></Image>
                  <Image src="/uploads/advert.jpg" w="100%"></Image>
                  <Image src="/uploads/advert.jpg" w="100%"></Image>
                </Box>
                <VStack backgroundColor="whiteAlpha.900" w="100%" alignItems="flex-start" height="450px" position="sticky" top="15px" p="1em">
